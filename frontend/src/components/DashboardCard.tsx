 ...
 * Fondo blanco por defecto con sombra sutil.
 * Animación Hover: Transición suave (duration-300) a gris oscuro/azulado (#4B5563) con texto en blanco.
 */
const DashboardCard: React.FC<DashboardCardProps> = ({ titulo, valor, unidad, subtitulo }) => {
