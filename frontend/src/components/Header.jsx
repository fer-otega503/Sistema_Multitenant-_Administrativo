...
/**
 * Componente Header
 * Ubicado en la parte superior del área de contenido con fondo blanco.
 * Muestra la fecha actual, título del negocio activo e información del usuario autenticado.
 */
const Header = ({ 
  nombreNegocio = 'Name...', 
  ...
  // Formatear la fecha actual DD/MM/YYYY
  const hoy = new Date();
